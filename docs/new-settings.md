...
| **Inline Matrices** | on/off | Print matrices and vectors on a single bracketed line. On (default) uses inline output; off uses a grid of aligned cells inside full-height brackets. |
